...
function init() {
  ...
  camera.position.set(
    standardCameraAngle.x,
    standardCameraAngle.y,
    standardCameraAngle.z,
  );
  ...
  bdpBumpTexture = new THREE.TextureLoader().load(
    "textures/bdp-final.jpg",
    (texture) => {
      texture.flipY = false;
    },
  );
  dpBumpTexture = new THREE.TextureLoader().load(
    "textures/dp-pattern-final.jpg",
    (texture) => {
      texture.flipY = false;
    },
  );
  patriotTexture = new THREE.TextureLoader().load(
    "textures/star-bump.jpg",
    (texture) => {
      texture.flipY = false;
    },
  );
  BK62BumpTexture = new THREE.TextureLoader().load(
    "textures/BK62-bump.jpg",
    (texture) => {
      texture.flipY = false;
    },
  );
  emissionMap = new THREE.TextureLoader().load(
    "textures/emissionMap.png",
    (texture) => {
      texture.flipY = false;
    },
  );
  ...
  new EXRLoader().load("hdrs/sunset_jhbcentral_1k.exr", function (texture) {
  ...
  document.getElementById("ladderrack").addEventListener("click", function () {
    ladderRackSelect();
  });
  // document.getElementById('hinge').addEventListener("click", function(){openLowSideLid()});
  document.getElementById("gullwing").addEventListener("click", function () {
    gullwingSelect();
  });
  document
    .getElementById("pup-gullwing-radio")
    .addEventListener("click", function () {
      renderPro();
      refreshConfig("config-toolbox-description", "Gullwing");
    });
  document
    .getElementById("pup-standard-radio")
    .addEventListener("click", function () {
      renderStandard();
      refreshConfig("config-toolbox-description", "Gullwing");
    });
  document.getElementById("hatch-nav").addEventListener("click", function () {
    hatchSelect();
  });
  document
    .getElementById("domed-hatch-radio")
    .addEventListener("click", function () {
      renderDomedHatch();
      refreshConfig("config-hatch-description", "Hatch");
    });
  document
    .getElementById("flat-hatch-radio")
    .addEventListener("click", function () {
      renderFlatHatch();
      refreshConfig("config-hatch-description", "Hatch");
    });
  document
    .getElementById("post-headache-rack-radio")
    .addEventListener("click", function () {
      switchToPostHeadacheRack();
      refreshConfig("config-headache-rack-description", "HeadacheRack");
    });
  document
    .getElementById("hex-headache-rack-radio")
    .addEventListener("click", function () {
      switchToHexHeadacheRack();
      refreshConfig("config-headache-rack-description", "HeadacheRack");
    });
  document
    .getElementById("no-ladder-rack-radio")
    .addEventListener("click", function () {
      hideLadderRack();
      refreshConfig("config-ladder-rack-description", "LadderRack");
    });
  document
    .getElementById("ladder-rack-radio")
    .addEventListener("click", function () {
      renderLadderRack();
      refreshConfig("config-ladder-rack-description", "LadderRack");
    });
  document
    .getElementById("additional-trays")
    .addEventListener("click", function () {
      additionalTraysSelect();
    });
  document
    .getElementById("lowside-tray-0-radio")
    .addEventListener("click", function () {
      renderLowSideTrays();
    });
  document
    .getElementById("lowside-tray-1-radio")
    .addEventListener("click", function () {
      renderLowSideTrays();
    });
  document
    .getElementById("lowside-tray-2-radio")
    .addEventListener("click", function () {
      renderLowSideTrays();
    });
  document
    .getElementById("gullwing-1-radio")
    .addEventListener("click", function () {
      renderGullwingTray();
    });
  document
    .getElementById("gullwing-2-radio")
    .addEventListener("click", function () {
      renderGullwingTray();
    });
  ...
  document
    .getElementById("additional-lights")
    .addEventListener("click", function () {
      additionalLightsSelect();
    });
  document
    .getElementById("LED-lights-radio")
    .addEventListener("click", function () {
      renderLights();
    });
  document
    .getElementById("no-LED-lights-radio")
    .addEventListener("click", function () {
      disableLights();
    });
  document
    .getElementById("lid-finishes")
    .addEventListener("click", function () {
      finishSelect();
    });
  document
    .getElementById("diamond-plate-radio")
    .addEventListener("click", function () {
      switchToDiamondPlate();
      refreshConfig("config-finish-description", "Finish");
    });
  document
    .getElementById("black-diamond-plate-radio")
    .addEventListener("click", function () {
      switchToBlackDiamondPlate();
      refreshConfig("config-finish-description", "Finish");
    });
  document
    .getElementById("leopard-radio")
    .addEventListener("click", function () {
      switchToLeopard();
      refreshConfig("config-finish-description", "Finish");
    });
  document
    .getElementById("gladiator-radio")
    .addEventListener("click", function () {
      switchToGladiator();
      refreshConfig("config-finish-description", "Finish");
    });
  // document.getElementById('open-gullwing').addEventListener("click", function(){openGullwing()});
  document.getElementById("truckslide").addEventListener("click", function () {
    truckslideSelect();
  });
  document
    .getElementById("no-truckslide-radio")
    .addEventListener("click", function () {
      hideTruckslide();
      refreshConfig("config-truckslide-description", "Truckslide");
    });
  document
    .getElementById("1200-truckslide-radio")
    .addEventListener("click", function () {
      chooseXT1200();
      refreshConfig("config-truckslide-description", "Truckslide");
    });
  document
    .getElementById("2000-truckslide-radio")
    .addEventListener("click", function () {
      chooseXT2000();
      refreshConfig("config-truckslide-description", "Truckslide");
    });
  document
    .getElementById("4000-truckslide-radio")
    .addEventListener("click", function () {
      chooseXT4000();
      refreshConfig("config-truckslide-description", "Truckslide");
    });
  ...
  document.getElementById("red-btn").addEventListener("click", function () {
    truckPaintMat.color.set(0x570000);
    truckPaintMat.sheenColor.set(0x2b0000);
  });
  document.getElementById("blue-btn").addEventListener("click", function () {
    truckPaintMat.color.set(0x001340);
    truckPaintMat.sheenColor.set(0x000000);
  });
  document.getElementById("grey-btn").addEventListener("click", function () {
    truckPaintMat.color.set(0x1f1f1f);
    truckPaintMat.sheenColor.set(0xffffff);
  });
  document.getElementById("black-btn").addEventListener("click", function () {
    truckPaintMat.color.set(0x050505);
    truckPaintMat.sheenColor.set(0xffffff);
  });
  document.getElementById("white-btn").addEventListener("click", function () {
    truckPaintMat.color.set(0xf0f0f0);
  });
  document
    .getElementById("back-btn-container")
    .addEventListener("click", function () {
      hideSidebar();
    });
  document
    .getElementById("congif-back-btn-container")
    .addEventListener("click", function () {
      hideConfigBar();
    });
  document
...
function headacheRackSelect() {
  ...
  gsap.to(camera.position, {
    ...
    z: 0,
    ease: "expo",
    onComplete: enableOrbitControls,
  });
  gsap.to(cameraTracker.position, {
    duration: 2,
    x: 5,
    y: 2,
    z: 0,
    ease: "expo",
    onComplete: changeTargetDistance(6, 20),
  });
...
function hatchSelect() {
  ...
  gsap.to(camera.position, {
    duration: 2,
    x: standardCameraAngle.x,
    y: standardCameraAngle.y,
    z: standardCameraAngle.z,
    ease: "expo",
    onComplete: enableOrbitControls,
  });
  gsap.to(cameraTracker.position, {
    ...
    z: 0,
    ease: "expo",
    onComplete: changeTargetDistance(10, 30),
  });
  controls.target = cameraTracker.position;
...
function finishSelect() {
  ...
  const blackDiamondPlateText = document.getElementById(
    "black-diamond-plate-radio-text",
  );
...
function additionalTraysSelect() {
  ...
  const gullwingDescription = document.getElementById(
    "config-gw-trays-count-id",
  );
...
function additionalLightsSelect() {
  ...
  gsap.to(emissiveLight, {
    duration: 2,
    emissiveIntensity: 10000000,
    ease: "expo",
  });
  gsap.to(renderer, { duration: 2, toneMappingExposure: 0.15, ease: "expo" });
...
async function addModelsToScene() {
  ...
  scene.traverse(function (child) {
    ...
    if (
      child.material &&
      child.material.name === "Black Diamond Plate Test 3"
    ) {
  ...
  GullwingModel.getObjectByName("gw-decimated-right-lid").material =
    bdpMaterial;
  ...
  LongLowSides.getObjectByName("standard-long-right-lid").material =
    bdpMaterial;
  LongFlatHatch.getObjectByName("Shape_IndexedFaceSet622").material =
    bdpMaterial;
  ShortDomedHatch.getObjectByName("Shape_IndexedFaceSet028").material =
    bdpMaterial;
  LongDomedHatch.getObjectByName("Shape_IndexedFaceSet012").material =
    bdpMaterial;
  ShortLowSides.getObjectByName("Shape_IndexedFaceSet118").material =
    emissiveLight;
  LongLowSides.getObjectByName("Shape_IndexedFaceSet095").material =
    emissiveLight;
...
function openLowSideLid() {
  ...
  gsap.to(hingePoint.rotation, {
    duration: 2,
    x: 2 * Math.PI * (160 / 360),
    ease: "expo",
  });
  gsap.to(LongLowSides.getObjectByName("long-ls-left-hinge").rotation, {
    duration: 2,
    x: 2 * Math.PI * (160 / 360),
    ease: "expo",
  });
...
function resetGlobalLight() {
  ...
  gsap.to(testLight, { duration: 0.015, intensity: 0, ease: "expo" });
}
  ...
  switch (determineLowSideCount()) {
    case 0:
      ...
      switch (clientPUP.Gullwing.enabled) {
        case true:
          PupAccessories.getObjectByName("lowside-tray-2").position.x =
            -2.76635;
          break;
        case false:
          PupAccessories.getObjectByName("lowside-tray-2").position.x =
    ...
    case 2:
      ...
      switch (clientPUP.Gullwing.enabled) {
        case true:
          PupAccessories.getObjectByName("lowside-tray-2").position.x =
            -2.76635;
          PupAccessories.getObjectByName("lowside-tray-3").position.x =
            -4.38547;
          break;
        case false:
          PupAccessories.getObjectByName("lowside-tray-2").position.x =
...
function openHatch() {
  if (!isHatchOpen) {
    ...
    gsap.to(LongFlatHatch.getObjectByName("Shape_IndexedFaceSet622").rotation, {
      duration: 2,
      y: 2 * Math.PI * (-10 / 360),
      ease: "expo",
    });
    gsap.to(
      LongDomedHatch.getObjectByName("Shape_IndexedFaceSet012").rotation,
      { duration: 2, y: 2 * Math.PI * (-10 / 360), ease: "expo" },
    );
    gsap.to(
      ShortDomedHatch.getObjectByName("Shape_IndexedFaceSet028").rotation,
      { duration: 2, y: 2 * Math.PI * (-15 / 360), ease: "expo" },
    );
    gsap.to(
      shortGladiatorFH.getObjectByName("short-hatch-gladiator").rotation,
      { duration: 2, y: 2 * Math.PI * (-15 / 360), ease: "expo" },
    );
    gsap.to(longGladiatorFH.getObjectByName("gladiator-long-hatch").rotation, {
      duration: 2,
      y: 2 * Math.PI * (-10 / 360),
      ease: "expo",
    });
    gsap.to(
      longGladiatorDH.getObjectByName("gladiator-long-dome-hatch").rotation,
      { duration: 2, y: 2 * Math.PI * (-10 / 360), ease: "expo" },
    );
    gsap.to(
      shortGladiatorDH.getObjectByName("gladiator-short-domed-hatch").rotation,
      { duration: 2, y: 2 * Math.PI * (-15 / 360), ease: "expo" },
    );
    ...
    gsap.to(
      LongDomedHatch.getObjectByName("Shape_IndexedFaceSet012").rotation,
      { duration: 2, y: 2 * Math.PI * (0 / 360), ease: "expo", delay: 0 },
    );
    gsap.to(
      ShortDomedHatch.getObjectByName("Shape_IndexedFaceSet028").rotation,
      { duration: 2, y: 2 * Math.PI * (0 / 360), ease: "expo", delay: 0 },
...
function openTailgate() {
  if (!isTailgateOpen && isHatchOpen) {
    gsap.to(TruckModel.getObjectByName("tailgate").rotation, {
      duration: 2,
      x: 2 * Math.PI * (-90 / 360),
      ease: "expo",
    });
...
function presentTruckslide() {
  ...
  gsap.to(LongDomedHatch.getObjectByName("Shape_IndexedFaceSet012").rotation, {
    duration: 2,
    y: 2 * Math.PI * (-10 / 360),
    ease: "expo",
  });
  gsap.to(ShortDomedHatch.getObjectByName("Shape_IndexedFaceSet028").rotation, {
    duration: 2,
    y: 2 * Math.PI * (-15 / 360),
    ease: "expo",
  });
  gsap.to(shortGladiatorFH.getObjectByName("short-hatch-gladiator").rotation, {
    duration: 2,
    y: 2 * Math.PI * (-15 / 360),
    ease: "expo",
  });
...
function closeTruckslide() {
  ...
  gsap.to(
    longGladiatorDH.getObjectByName("gladiator-long-dome-hatch").rotation,
    { duration: 2, y: 2 * Math.PI * (0 / 360), ease: "expo", delay: 1 },
  );
  gsap.to(
    shortGladiatorDH.getObjectByName("gladiator-short-domed-hatch").rotation,
    { duration: 2, y: 2 * Math.PI * (0 / 360), ease: "expo", delay: 1 },
...
function openGullwing() {
  gsap.to(GullwingModel.getObjectByName("GW-left-hinge").rotation, {
    duration: 2,
    x: 135 * (Math.PI / 180),
    ease: "expo",
  });
...
function switchToLeopard() {
  ...
  GullwingModel.getObjectByName("gw-decimated-left-lid").material =
    leopardMaterial;
  GullwingModel.getObjectByName("gw-decimated-right-lid").material =
    leopardMaterial;
  ShortLowSides.getObjectByName("standard-left-lid").material = leopardMaterial;
  ShortLowSides.getObjectByName("standard-right-lid").material =
    leopardMaterial;
  LongLowSides.getObjectByName("standard-long-left-lid").material =
    leopardMaterial;
  LongLowSides.getObjectByName("standard-long-right-lid").material =
    leopardMaterial;
  LongFlatHatch.getObjectByName("Shape_IndexedFaceSet622").material =
